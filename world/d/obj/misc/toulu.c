// toulu.c -- a severed head (头颅), the turn-in item for behead bounties.
// Ported from xyj2006 d/obj/misc/toulu.c for xyj450. Loaded by
// CHAR_D->make_toulu as "/d/obj/misc/toulu".
//
// Self-contained: depends only on ITEM (/std/item) and standard efuns.
// Decays over time (head -> rotten head -> skull -> dust) and then destructs.
